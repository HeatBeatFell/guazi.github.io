...
// 城市
document.querySelector('.choose-city').onmouseover = function () {
    document.querySelector('.city-box').style.display = 'block';
    document.querySelector('.actv').classList.add('active');
   
}
document.querySelector('.choose-city').onmouseout = function () {
    document.querySelector('.city-box').style.display = 'none';
    document.querySelector('.actv').classList.remove('active');
}
document.querySelector('.city-box').onmouseover = function () {
    document.querySelector('.city-box').style.display = 'block';
    document.querySelector('.actv').classList.add('active');
   
}
document.querySelector('.city-box').onmouseout = function () {
    document.querySelector('.city-box').style.display = 'none';
    document.querySelector('.actv').classList.remove('active');
}